          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-2.5">
              <a href="https://wa.me/967777033002" target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-white/5 hover:bg-green-500/15 flex items-center justify-center transition-all duration-300 group">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="#25D366" className="opacity-30 group-hover:opacity-100 transition-opacity duration-300">
