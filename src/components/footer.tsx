          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a href="https://wa.me/967777033002" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-white/5 hover:bg-cyan-500/20 flex items-center justify-center transition-all duration-200 group">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-white/30 group-hover:text-cyan-500 transition-colors">
              ...
              <a href="mailto:info@sayunmedical.com"
                className="w-9 h-9 rounded-lg bg-white/5 hover:bg-cyan-500/20 flex items-center justify-center transition-all duration-200 group">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-white/30 group-hover:text-cyan-500 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/35">
              <li className="flex items-start gap-3">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="shrink-0 mt-0.5 text-cyan-500/50"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
                {locale === "ar" ? "شارع التحرير، صنعاء، اليمن" : "Al-Tahreer St, Sana'a, Yemen"}
              </li>
              <li className="flex items-center gap-3">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="shrink-0 text-cyan-500/50"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/></svg>
                <a href="tel:00967777033002" className="hover:text-cyan-500 transition-colors">00967-777-033-002</a>
              </li>
              <li className="flex items-center gap-3">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="shrink-0 text-cyan-500/50"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                <a href="mailto:info@sayunmedical.com" className="hover:text-cyan-500 transition-colors">info@sayunmedical.com</a>
              </li>
            </ul>
          </div>
        </div>
        <div className="mt-14 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/20 pb-10">
          <p>&copy; {new Date().getFullYear()} Sayun Medical Corporation. {t[locale].rights}</p>
          <p>
            {locale === "ar" ? "تصميم وتطوير" : "Designed & Built with"}
